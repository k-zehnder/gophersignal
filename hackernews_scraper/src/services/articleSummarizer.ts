...
- If the article is behind a paywall, return ONLY "PAYWALL".
- If the content is an advertisement, return ONLY "ADVERTISEMENT".
...
SPECIAL CASES:
- If encountering a paywall, return: PAYWALL
- If an ad, return: ADVERTISEMENT
`;
...
3. If the article is inaccessible, return "PAYWALL" or "ADVERTISEMENT" as appropriate.`,
          },
          {
            role: 'user',
            content: prompt,
      ...
      return (
        parsedResponse.summary?.replace(/^PAYWALL$/i, 'PAYWALL') ??
